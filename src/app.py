...
def require_teacher(
    ...
    teacher = teacher_tokens.get(credentials.credentials)
    if not teacher:
...
def login(request: LoginRequest):
    ...
    teacher = next(
        (
            ...
            if secrets.compare_digest(teacher["username"], request.username)
            and secrets.compare_digest(teacher["password"], request.password)
        ),
        None,
    )
